    ...
    public function up(): void
    {
        Schema::create('monthly_kpis', function (Blueprint $table) {
            ...
            */
            ...
            $table->integer('new_chemists')
                ->default(0);

            $table->integer('new_distributors')
                ->default(0);
            ...
            */
            ...
            $table->decimal('fraud_loss_amount', 15, 2)
                ->default(0);
            ...
            */
            ...
            $table->decimal('customer_retention_rate', 8, 2)
                ->default(0);
